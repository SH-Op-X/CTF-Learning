...
cmp = [0x1E, 0x70, 0x7A, 0x6E, 0xEA, 0x83, 0x9E, 0xEF, 0x96, 0xE2, 0xB2, 0xD5, 0x99, 0xBB, 0xBB, 0x78, 0xB9, 0x3D, 0x6E, 0x38, 0x42, 0xC2, 0x86, 0xFF, 0x63, 0xBD, 0xFA, 0x79, 0xA3, 0x6D, 0x60, 0x94, 0xB3, 0x42, 0x11, 0xC3, 0x90, 0x89, 0xBD, 0xEF, 0xD4, 0x97, 0xF8, 0x7B, 0x8B, 0x0B, 0x2D, 0x75, 0x7E, 0xDD, 0xCB]
dword_140005000 = 0x19
a = 0
for i in range(51):
    a = (127 * a + 102) % 255
    if a >> 7 == 0:
        dword_140005000 = (97 * dword_140005000 + 101) % 233
        dword_140005000 ^= 0x29
    cmp[i] ^= xor[dword_140005000]
